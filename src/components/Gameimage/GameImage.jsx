    ...
    <div>
      ...
      >
        ...
        <div className="game gameblock1_2">
          <img
            src="https://mcdn.wallpapersafari.com/medium/57/90/BRi1qC.jpg"
            alt=""
          />
          <h4>open world</h4>
          <p>
        ...
        <div className="game gameblock1_3">
          <img
            src="http://dota2booster.ir/wp-content/uploads/2018/10/40971511-dota-2-logo-wallpapers-1024x576.jpg"
            alt=""
          />
